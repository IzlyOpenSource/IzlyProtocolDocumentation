...
Ce document est diffusé sous la licence "DO WHAT THE FUCK YOU WANT TO PUBLIC LICENSE" (aka WTFPL, disponible sur http://sam.zoy.org/wtfpl/COPYING), dans l'espoir de contribuer au développement d'un client libre, sans pubs ni tracking...
...
II.1 Format géneral des requêtes
...
II.2 Arguments véhiculant des données d'authentification
...
- Le token, contenu dans le noeud XML sous le chemin: /Logon/OAUTH/ACCESS_TOKEN
...
$ ./freezly.py login <phone> <password>
